...
sample9SD<-sd(x.avg)
```
The mean for the sample 9 is `r sample9mean`  with sample 9 standard devation is `r sample9SD`.
...
The mean for the sample 16 is `r sample16mean`  with sample 16 standard devation is `r sample16SD`.
...
sample25SD<-sd(x.avg)
```
The mean for the sample 25 is `r sample25mean`  with sample 25 standard devation is `r sample25SD`.
...
The mean for the sample 36 is `r sample36mean`  with sample 36 standard devation is `r sample36SD`.
